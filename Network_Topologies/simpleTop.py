...
if __name__ == '__main__':
    ...
    #disable the automatic assignment of IPv4
    ...
    print "router forward table setup complete"
    ...
    print "forwarding for routers complete"
